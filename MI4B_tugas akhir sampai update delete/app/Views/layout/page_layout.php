...
<head>
    ...
    <title>Data kadek indri </title>
    <link rel="stylesheet" href="/assest/css/bootstrap.min.css">
    <script src="/assest/js/unpkg.com_sweetalert@2.1.2_dist_sweetalert.min.js"></script> <!-- tambahkan ini -->
</head>
<body>
    ...
    <div class="container">
        ...
        <footer class="row row-cols-5 py-5 my-5 border-top">
            <div class="container text-center">anyong haseyo
                <?= Date('Y') ?>
                <div class="container text-center">kadek indri wedayani
            </div>
        </footer>
    </div>
