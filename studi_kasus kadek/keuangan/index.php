...
?>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
<h1> Dana kas kecil <?=$_SESSION['nama']?></h1>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Sisa Uang (SALDO)</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> KAS MASUK
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-danger"></i> KAS KELUAR
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-info"></i> Sisa SALDO
                    </span>
                  </div>
                </div>
              </div>
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      backgroundColor: ['#4e7465', '#e74a3b', '#36b9cc'],
